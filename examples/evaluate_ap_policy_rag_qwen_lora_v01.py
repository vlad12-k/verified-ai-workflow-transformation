"""Evaluate the AP policy LoRA specialist on RAG benchmark v0.1."""
...
class RecordingRAGRunner:
    """Record RAG outputs and latency without repeated generation."""
    ...
    def run(
        ...
        """Run one query and record one trace."""
...
print(
    "Generator:",
    report.generator_implementation_id,
)
